        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-surface-container-lowest rounded-lg border border-outline-variant p-6">
            ...
            <div className="flex items-baseline gap-1 mb-1">
              <span className="text-3xl font-bold text-on-surface">{billingData.amount}</span>
          ...
          <div className="bg-surface-container-lowest rounded-lg border border-outline-variant p-6">
            ...
            <div className="flex items-center justify-between p-4 bg-surface rounded-lg border border-outline-variant/20">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-on-surface">•••• •••• •••• {billingData.paymentMethod.last4}</p>
          ...
          {/* Invoice History */}
          <div className="bg-surface-container-lowest rounded-lg border border-outline-variant p-6">
            <h2 className="text-lg font-bold text-on-surface mb-4">Invoice History</h2>
                ...
                <tbody>
                  {billingData.invoices.map((inv) => (
                    <tr key={inv.id} className="border-t border-outline-variant/20 hover:bg-surface-container-low/50 transition-colors">
                      <td className="px-4 py-3 text-sm font-medium text-on-surface">{inv.id}</td>
        ...
        <div className="space-y-6">
          <div className="bg-surface-container-lowest rounded-lg border border-outline-variant p-5">
            ...
            <div className="text-center mb-4">
              <span className="text-3xl font-bold text-on-surface">{billingData.credits.total - billingData.credits.used}</span>
            ...
            <button className="w-full mt-4 py-2.5 bg-accent text-on-surface text-sm font-semibold rounded hover:bg-amber-400 transition-colors">
              Buy More Credits
            </button>
          </div>
